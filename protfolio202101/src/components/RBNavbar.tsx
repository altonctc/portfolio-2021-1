    ...
    return (
        <div>
            ...
            >
                <Navbar.Brand
                    href="#home"
                    className="d-block d-xl-none mx-3 py-3 "
                >
                    React-Bootstrap
                </Navbar.Brand>
                <Navbar.Toggle
                    aria-controls="responsive-navbar-nav navbar-expand-md"
                ...
                >
                    <Nav className="col-lg-5 me-auto p-0 h-100">
                        <NavLink href="#features" className="py-3 px-0 mx-3">
                            Menu
                        </NavLink>
                        <NavLink href="#features" className="py-3 px-0 mx-3">
                            Faq
                        </NavLink>
                        <NavLink href="#pricing" className="py-3 px-0 mx-3">
                            Uber Eats
                        </NavLink>
                    </Nav>
                    <Navbar.Brand
                        href="#home"
                        className="d-none d-xl-block mx-auto text-center col-auto py-3"
                    >
                        React-Bootstrap
                    </Navbar.Brand>
                    <Nav className="col-lg-5 justify-content-end p-0">
                        ...
                        >
                            ...
                            <StyledNavDropdownItem eventKey="4.2">
                                Another action
                            </StyledNavDropdownItem>
                            <StyledNavDropdownItem eventKey="4.3">
                                Something else here
                            </StyledNavDropdownItem>
                        </StyledNavDropdown>
                        <NavLink href="#deets" className="py-3 px-0 mx-3">
                            About Us
                        </NavLink>
                        <NavLink href="#memes" className="py-3 px-0 mx-3">
                            Blog
                        </NavLink>
                        <NavLink href="#memes" className="py-3 px-0 mx-3">
                            Contact Us
                        </NavLink>
                        <NavIcon href="#memes" className="py-3 px-0 mx-3">
                            <StyledEnvelop size={20} />
                        </NavIcon>
                    </Nav>
                </Navbar.Collapse>
            </StyledNavbar>
